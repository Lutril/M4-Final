/*
Flip the eagles    //Sami
 Add hittracking eagles and ravens     //Sami
 HP on ravens                    //Sami
 Birdnado needs fixing          //Sami
 Score                 //Jelle
 OnHitDie             //Jelle
 Move the birdnado spell to a new class      //Jelle
 Other visual stuff    (layering mountains)      //Jelle
 Flying Carpet // Jelle
